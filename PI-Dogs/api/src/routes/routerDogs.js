...
const {handlerAllDogs, handlerIdDog, handlerNameDog, handlerCreateDog} = require('../handlers/dogsHandler')
const routerDog = Router();

routerDog.get('/', handlerAllDogs) //recibe todos los jaguas //OK
routerDog.get('/name', handlerNameDog) //recibe todos los jaguas //OK
